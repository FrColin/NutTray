...
protected:
   ...
   bool FetchStatus(int &battstat, string &statstr, string &upsname);
   ...
   wstring                 _upsname;        // Cache UPS name
   wstring                 _laststatus;     // Cache previous status string
   ...
   HANDLE                  _mutex;          // Lock to protect statmgr
   WPARAM                  _generation;
   bool                    _reconfig;
